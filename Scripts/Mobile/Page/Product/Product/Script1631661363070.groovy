...
if (isLogin == 0) {
	...
	Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Button - Mutual Funds'), 0)
	
	'Klik Buy pada Bahana Revolving Fund'
	Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Button - Buy Bahana Revolving Fund'), 0)
...
if (action == 'Product Detail') {
	...
	Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Button - Bahana Revolving Fund'),
		0)
	...
	if (pageSelection == 'Performance') {
		...
		if (isBuy == 1) {
			...
			'Input 100.000'
			Mobile.setText(findTestObject('Mobile/Page/Products/Performance/Beli Reksadana/Input - Jumlah Pembelian'), '100000', 0)
			
			Mobile.hideKeyboard()
			
			'Tap 500.000'
			Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Beli Reksadana/Button - Jumlah Pembelian 500 ribu'), 0)
			
			'Tap 1.000.000'
			Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Beli Reksadana/Button - Jumlah Pembelian 1 juta'), 0)
			
			'Tap 1.500.000'
			Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Beli Reksadana/Button - Jumlah Pembelian 1,5 juta'), 0)
			...
			if (gunakanKodePromo == 1) {
				...
				Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Beli Reksadana/Button - Pakai Promo or Kode Promo'), 0)
				
				'Button - Gunakan Kode Promo'
				Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Beli Reksadana/Kode Promo/Button - Gunakan Promo'), 0)
			...
			if (actionBeliReksadana == 'Bayar') {
				...
				if (metodePambayaran == 'Rekening Data Nasabah') {
					...
					Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Metode Pembayaran/Radiobutton - Rekening Data Nasabah'), 0)
					Mobile.swipe(77, 939, 77, 439, FailureHandling.STOP_ON_FAILURE)
				} else if (metodePambayaran == 'e-Wallet') {
					if (eWallet == 'Gopay') {
						'eWallet Gopay'
						Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Metode Pembayaran/Radiobutton - Gopay'), 0)
						...
						'eWallet Link Aja'
						Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Metode Pembayaran/Radiobutton - Link Aja'), 0)
						Mobile.swipe(77, 939, 77, 339, FailureHandling.STOP_ON_FAILURE)
					}
				} else if (metodePambayaran == 'Bank Virtual Account') {
					if (bankVirtualAccount == 'BCA') {
						'VA BCA'
						Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Metode Pembayaran/Radiobutton - VA BCA'), 0)
						Mobile.swipe(77, 939, 77, 339, FailureHandling.STOP_ON_FAILURE)
					} else if (bankVirtualAccount == 'BNI') {
						'VA BNI'
						Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Metode Pembayaran/Radiobutton - VA BNI'), 0)
						Mobile.swipe(77, 939, 77, 339, FailureHandling.STOP_ON_FAILURE)
					} else if (bankVirtualAccount == 'BNI Syariah') {
						Mobile.swipe(77, 939, 77,3839, FailureHandling.STOP_ON_FAILURE)
						'VA BNI Syariah'
						Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Metode Pembayaran/Radiobutton - BNI Syariah'), 0)
					} else if (bankVirtualAccount == 'Bank Mandiri') {
						Mobile.swipe(77, 939, 77, 339, FailureHandling.STOP_ON_FAILURE)
						'VA Mandiri'
						Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Metode Pembayaran/Radiobutton - VA Mandiri'), 0)
					} else if (bankVirtualAccount == 'Bank Permata') {
						Mobile.swipe(77, 939, 77, 339, FailureHandling.STOP_ON_FAILURE)
						'VA Permata'
						Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Metode Pembayaran/Radiobutton - VA Bank Permata'), 0)
					} else if (bankVirtualAccount == 'Bank Sahabat Sampoerna') {
						Mobile.swipe(77, 939, 77, 339, FailureHandling.STOP_ON_FAILURE)
						'VA Sahabat Sampoerna'
						Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Metode Pembayaran/Radiobutton - VA Bank Sahabat Sampoerna'), 0)
					} else if (bankVirtualAccount == 'BRI') {
						Mobile.swipe(77, 939, 77, 339, FailureHandling.STOP_ON_FAILURE)
						'VA BRI'
						Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Metode Pembayaran/Radiobutton - VA Bank BRI'), 0)
					} else if (bankVirtualAccount == 'Bank CIMB Niaga') {
						Mobile.swipe(77, 939, 77, 339, FailureHandling.STOP_ON_FAILURE)
						'VA CIMB Niaga'
						Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Metode Pembayaran/Radiobutton - VA Bank CIMB Niaga'), 0)
					} else if (bankVirtualAccount == 'Bank Syariah Indonesia') {
						Mobile.swipe(77, 939, 77, 339, FailureHandling.STOP_ON_FAILURE)
						'VA Bank Syariah Indonesia'
						Mobile.tap(findTestObject('Mobile/Page/Products/Performance/Metode Pembayaran/Radiobutton - VA Bank Syariah Indonesia'), 0)
					}
				}
