...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Masukkan alamat email kamu' or . = 'Masukkan alamat email kamu') and @resource-id = '']</locator>
